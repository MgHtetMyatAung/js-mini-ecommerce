                ...
                <div class="col-lg-3">
                    <div class="border border-2 p-3">
                        ...
                        <div class="pt-3">
                            ...
                            <div class="d-flex justify-content-between my-3" value="${num}">
        ...
        x.addEventListener("click",function(e){
            ...
            <div class="col-lg-6">
                <div class="m-2">
                    ...
                    <br><br>
                    <label for="quantity" class="mb-3">Quantity</label> <br>
...
let invoiceItems=[];
let addInvoice=document.querySelector(".addInvoice");
let showInvoice=document.getElementById("showInvoice");
let trow=document.getElementById("trow");
let total=document.querySelector(".total");


addInvoice.addEventListener("click",function(e){
    if(confirm("Are you sure to buy?")){
        let title=e.target.parentElement.parentElement.children[1].children[0].children[1].children[0].querySelector(".show-title").value;
        let price=e.target.parentElement.parentElement.children[1].children[0].children[1].children[0].querySelector(".show-price").value;
        let qty=e.target.parentElement.parentElement.children[1].children[0].children[1].children[0].querySelector("#qty").value;
        invoiceItems.push({title,price,qty});
    }
...
showInvoice.addEventListener("click",function(){
    trow.innerHTML=null;
    let num=1;
    invoiceItems.forEach(x=>{
        ...
        trow.innerHTML+= `
            <tr>
                ...
                <td class="text-end costItem">${cost}</td>
            </tr>
        `;
        num++;
    });

    let costItem=document.querySelectorAll(".costItem");
    let totalCost;
    totalCost= [...costItem].reduce((pv,cv)=>{
